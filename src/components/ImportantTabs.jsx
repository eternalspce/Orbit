...
const ImportantTabs = ({ dragHandleProps, tabsConfig }) => {
  ...
  return (
    <div className="figma-glass-static important-tabs-widget rounded-[26px] px-4 py-3 text-white font-gilroy-medium w-full h-full select-none flex flex-col justify-between shadow-2xl relative overflow-hidden">
      {/* Header Row */}
