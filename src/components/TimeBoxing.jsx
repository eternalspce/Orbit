...
const TimeBoxing = ({ dragHandleProps, externalGroups, onGroupsChange }) => {
  const [explicitlyExpandedId, setExplicitlyExpandedId] = useState(null);
  ...
  const expandedId = explicitlyExpandedId === "none"
    ? null
    : explicitlyExpandedId !== null
      ? explicitlyExpandedId
      : activeId;
  ...
  return (
    <div className="figma-glass-static timeboxing-widget rounded-[26px] px-4 py-3 text-white font-gilroy-medium w-full h-full select-none flex flex-col shadow-2xl relative overflow-hidden">
      {/* Header Row */}
                ...
                <div className={`flex-1 min-w-0 ${isLast ? "" : "pb-5"}`}>
                  ...
                  >
                    ...
                    <div
                      ...
                      onClick={() => setExplicitlyExpandedId(expanded ? "none" : group.id)}
                    >
