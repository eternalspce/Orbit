...
const WaterReminder = ({ dragHandleProps, goalMl: goalMlProp }) => {
  // goalMl is derived: prefer the incoming prop (set from Settings), fall back to 4500
  const goalMl = (goalMlProp && goalMlProp > 0) ? goalMlProp : 4500;
  ...
  return (
    <div className="figma-glass-static water-widget rounded-[26px] px-4 py-2.5 text-white font-gilroy-medium w-full h-full select-none flex flex-col justify-between shadow-2xl relative overflow-hidden">
      ...
      <div className="w-full flex items-center justify-between gap-3.5 z-10 relative my-auto">
        ...
        <div className="water-progress-ring relative w-26 h-26 sm:w-28 sm:h-28 rounded-full overflow-hidden border border-white/80 flex items-center justify-center shrink-0 shadow-inner">
          {/* Liquid Fill */}
          <div
            className="water-progress-fill absolute bottom-0 left-0 right-0 transition-all duration-700 ease-out"
          ...
          >
            ...
            {percentage > 0 && percentage < 100 && (
              <div className="absolute -top-[12px] left-0 w-[200%] h-[14px] pointer-events-none">
                <svg
                  className="water-progress-wave w-full h-full animate-wave-loop"
