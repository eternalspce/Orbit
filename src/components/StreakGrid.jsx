...
const StreakGrid = ({ dragHandleProps }) => {
  ...
  return (
    <div
      ...
      className={`figma-glass-static streak-widget rounded-[26px] px-4 py-2.5 text-white font-gilroy-medium w-full h-full select-none flex flex-col shadow-2xl relative transition-all ${
