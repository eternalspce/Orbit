...
import { PUBLIC_UI_THEMES } from "../themes/index.js";
...
const NAV_TABS = [
  ...
  { id: "todo", label: "Notepad / Todo", icon: "ri-file-text-line" },
  { id: "streak", label: "Streak Grid", icon: "ri-calendar-check-line" },
...
const TimeDropdownPopover = ({ current, onSelect, onClose, uiTheme = "default" }) => {
  ...
  // openUpwards is computed on first render via a ref trick (avoids setState-in-effect lint warning)
  const openUpwardsInit = useRef(false);
  ...
  useEffect(() => {
    // Check position after mount to decide direction; use a callback to avoid sync setState
    const raf = requestAnimationFrame(() => {
      if (popoverRef.current) {
        const rect = popoverRef.current.getBoundingClientRect();
        if (rect.bottom > window.innerHeight - 20 && !openUpwardsInit.current) {
          openUpwardsInit.current = true;
          setOpenUpwards(true);
        }
      }
    });
...
const IconDropdownPopover = ({ current, onSelect, onClose, uiTheme = "default" }) => {
  const popoverRef = useRef(null);
  // openUpwards is computed after mount via rAF to avoid sync setState-in-effect lint error
  const openUpwardsInit = useRef(false);
  const [openUpwards, setOpenUpwards] = useState(false);
...
const FocusTab = ({
  ...
  <div className="flex flex-col gap-6">
    ...
    <CardContainer
      ...
      description="Show or hide the Focus and Hydration widgets on your dashboard."
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
              <i className="ri-timer-line relative z-10" />
            </div>
            <div>
              <h4 className="text-white text-xs font-gilroy-bold">Focus Timer Widget</h4>
              <p className="text-white/50 text-[11px] font-gilroy-medium">Pomodoro & rest countdown timer card</p>
            </div>
          </div>
          <Toggle checked={showTimer} onChange={onShowTimerChange} />
        </div>

        <div className="flex items-center justify-between pt-3 border-t border-white/5">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
              <i className="ri-drop-line relative z-10" />
            </div>
            <div>
              <h4 className="text-white text-xs font-gilroy-bold">Water Reminder Widget</h4>
              <p className="text-white/50 text-[11px] font-gilroy-medium">Liquid animation hydration goal & counter</p>
            </div>
          </div>
          <Toggle checked={showWaterReminder} onChange={onShowWaterReminderChange} />
        </div>
      </div>
    </CardContainer>
...
const SongPlayerTab = ({
  ...
  <div className="flex flex-col gap-6">
    ...
    <CardContainer
      title="Widget Visibility"
      description="Show or hide the 24/7 Song Player widget on your dashboard."
    >
      <div className="flex items-center justify-between pt-3 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
            <i className="ri-music-2-line relative z-10" />
          </div>
          <div>
            <h4 className="text-white text-xs font-gilroy-bold">Song Player Widget</h4>
            <p className="text-white/50 text-[11px] font-gilroy-medium">24/7 Lofi live stream music player</p>
          </div>
        </div>
        <Toggle checked={showSongPlayer} onChange={onShowSongPlayerChange} />
      </div>
    </CardContainer>
...
const TaskbarTab = ({
  showTaskbar, onShowTaskbarChange,
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <CardContainer
        title="Widget Visibility"
        description="Show or hide the Taskbar Shortcuts widget at the top of your dashboard."
      >
        <div className="flex items-center justify-between pt-3 border-t border-white/10">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
              <i className="ri-external-link-line relative z-10" />
            </div>
            <div>
              <h4 className="text-white text-xs font-gilroy-bold">Taskbar Shortcuts Widget</h4>
              <p className="text-white/50 text-[11px] font-gilroy-medium">Quick link launcher icons at the top of the screen</p>
            </div>
          </div>
          <Toggle checked={showTaskbar} onChange={onShowTaskbarChange} />
        </div>
      </CardContainer>
...
const ImportantTabsTab = ({ showImportantTabs, onShowImportantTabsChange, importantTabsConfig, onImportantTabsConfigChange, uiTheme = "default" }) => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <CardContainer
        title="Widget Visibility"
        description="Show or hide the Important Tabs widget on your dashboard."
      >
        <div className="flex items-center justify-between pt-3 border-t border-white/10">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
              <i className="ri-bookmark-3-line relative z-10" />
            </div>
            <div>
              <h4 className="text-white text-xs font-gilroy-bold">Important Tabs Widget</h4>
              <p className="text-white/50 text-[11px] font-gilroy-medium">Categorized quick bookmarks and links</p>
            </div>
          </div>
          <Toggle checked={showImportantTabs} onChange={onShowImportantTabsChange} />
        </div>
      </CardContainer>
...
/* ─── TAB 5: Time Boxing ─── */
const TimeBoxingTab = ({ showTimeBoxing, onShowTimeBoxingChange, timeBoxingGroups, onTimeBoxingGroupsChange, uiTheme = "default" }) => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <CardContainer
        title="Widget Visibility"
        description="Show or hide the Time Boxing routines widget on your dashboard."
      >
        <div className="flex items-center justify-between pt-3 border-t border-white/10">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
              <i className="ri-time-line relative z-10" />
            </div>
            <div>
              <h4 className="text-white text-xs font-gilroy-bold">Time Boxing Routines</h4>
              <p className="text-white/50 text-[11px] font-gilroy-medium">Daily time blocking and scheduled task cards</p>
            </div>
          </div>
          <Toggle checked={showTimeBoxing} onChange={onShowTimeBoxingChange} />
        </div>
      </CardContainer>
...
/* ─── TAB 6: Notepad / Todo ─── */
const NotepadTab = ({ showTodo, onShowTodoChange }) => (
  <div className="flex flex-col gap-6">
    <CardContainer
      title="Widget Visibility"
      description="Show or hide the Notepad and To Do checklist card on your dashboard."
    >
      <div className="flex items-center justify-between pt-3 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
            <i className="ri-file-text-line relative z-10" />
          </div>
          <div>
            <h4 className="text-white text-xs font-gilroy-bold">Notepad / To Do Checklist</h4>
            <p className="text-white/50 text-[11px] font-gilroy-medium">Quick notes and task checklist card</p>
          </div>
        </div>
        <Toggle checked={showTodo} onChange={onShowTodoChange} />
      </div>
    </CardContainer>
  </div>
);
...
/* ─── TAB 7: Streak Grid ─── */
const StreakGridTab = ({ showStreakGrid, onShowStreakGridChange }) => (
  <div className="flex flex-col gap-6">
    <CardContainer
      title="Widget Visibility"
      description="Show or hide the Streak Activity contribution grid on your dashboard."
    >
      <div className="flex items-center justify-between pt-3 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-[color:var(--theme)]/20 border border-white/15 flex items-center justify-center text-white text-base shrink-0 shadow-inner">
            <i className="ri-calendar-check-line relative z-10" />
          </div>
          <div>
            <h4 className="text-white text-xs font-gilroy-bold">Streak Activity Grid</h4>
            <p className="text-white/50 text-[11px] font-gilroy-medium">GitHub-style daily contribution grid</p>
          </div>
        </div>
        <Toggle checked={showStreakGrid} onChange={onShowStreakGridChange} />
      </div>
    </CardContainer>
  </div>
);

/* ─── TAB 8: Widget Visibility ─── */
const WidgetsTab = ({
  showTimer, onShowTimerChange,
  showWaterReminder, onShowWaterReminderChange,
  showSongPlayer, onShowSongPlayerChange,
  ...
  >
    <div className="flex flex-col gap-1 pt-3 border-t border-white/10">
      {[
        ...
        { title: "Taskbar Shortcuts Widget", desc: "Quick link launcher icons at the top of the screen", state: showTaskbar, set: onShowTaskbarChange, icon: "ri-external-link-line" },
      ].map((w, idx) => (
...
const SettingsPage = (props) => {
  ...
  return (
    <div
      className="winter-settings-page fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 md:p-8 bg-black/60 backdrop-blur-md text-white font-gilroy-medium overflow-hidden pointer-events-auto animate-fade-in"
      ...
      >
        ...
        <div className="w-full flex-1 flex min-h-0 overflow-hidden z-20 relative">
          ...
          <aside className="w-64 sm:w-72 border-r border-white/15 p-6 flex flex-col justify-between shrink-0 select-none bg-black/10">
            ...
            {/* Footer Reset, Social & Credit Links */}
            <div className="flex flex-col gap-3 pt-4 border-t border-white/10">
              {/* Reset All Settings to Default CTA */}
              <button
                type="button"
                onClick={() => {
                  if (window.confirm("Are you sure you want to reset all settings to their default values?")) {
                    props.onResetAllSettings?.();
                  }
                }}
                className="winter-reset-button w-full py-2.5 rounded-xl text-[11px] text-white/90 hover:text-white font-gilroy-bold border transition-all duration-300 ease-out hover:brightness-110 active:scale-[0.97] cursor-pointer flex items-center justify-center gap-1.5 shadow-sm"
                style={{
                  backgroundColor: "color-mix(in srgb, var(--theme, #5C5C5C) 16%, #151515)",
                  borderColor: "color-mix(in srgb, var(--theme, #5C5C5C) 44%, #303030)",
                }}
                title="Reset all settings to default"
              >
                <i className="ri-restart-line text-sm relative z-10" style={{ color: "var(--theme, #5C5C5C)" }} />
                <span className="relative z-10">Reset All Settings</span>
              </button>

              <p className="text-white/40 text-[11px] text-center font-gilroy-medium">
                Orbit
              </p>
          </div>
        </aside>
        ...
        <main className="flex-1 min-w-0 h-full overflow-y-auto scrollbar-hide p-8 sm:p-10">
          <div className="max-w-4xl mx-auto flex flex-col gap-6">
            ...
            {activeTab === "taskbar" && (
              <TaskbarTab
                showTaskbar={props.showTaskbar}
                onShowTaskbarChange={props.onShowTaskbarChange}
